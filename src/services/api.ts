...
export class ApiService {
  ...
  static async getUser(userId: string): Promise<User | null> {
    try {
      // Backend endpoint: GET /v1/admin/users/:id
  ...
  static async searchUsers(query: string): Promise<User[]> {
    try {
      // Backend endpoint: GET /v1/admin/users?search=query
  ...
  static async updateUser(userId: string, data: Partial<User>): Promise<User> {
    // Backend endpoint: PATCH /v1/admin/users/:id
  ...
  static async getVendor(vendorId: string): Promise<Retailer | null> {
    try {
      // Backend endpoint: GET /v1/admin/vendors/:vendorId
  ...
  static async searchVendors(query: string): Promise<Retailer[]> {
    try {
      // Backend endpoint: GET /v1/admin/vendors?name=query
  ...
  static async updateVendor(vendorId: string, data: Partial<Retailer>): Promise<Retailer> {
    // Backend endpoint: PATCH /v1/admin/vendors/:vendorId
