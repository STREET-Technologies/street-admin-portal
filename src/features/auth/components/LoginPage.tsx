        ...
        <Card className="border-0 bg-white/95 shadow-2xl backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              variant="outline"
              className="flex h-12 w-full items-center justify-center gap-3 border-gray-300 bg-white font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-50"
            >
              <GoogleIcon />
              Sign in with Google
            </Button>
